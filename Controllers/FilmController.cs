...
namespace FilmProject.Controllers
{
    ...
    public class FilmController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<RetApi<List<DtoFilteredFilms>>> GetAllFilms()
        {
        ...
        [HttpGet("filtered")]
        public ActionResult<RetApi<List<DtoFilteredFilms>>> GetFilteredFilms([FromQuery] DtoFilmsQuery filmDto)
        {
