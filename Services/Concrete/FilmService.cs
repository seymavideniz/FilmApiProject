...
public class FilmService : IFilmService
{
    ...
    public ApiResponse<List<DtoFilteredFilms>> GetAllFilms()
    {
        try
        {
            ...
            if (films.Count == 0)
            {
                return new ApiResponse<List<DtoFilteredFilms>>()
                {
                    Error = "FilmNotFound",
            ...
            return new ApiResponse<List<DtoFilteredFilms>> { Data = films };
        }
        catch (Exception ex)
        {
            return new ApiResponse<List<DtoFilteredFilms>>
    ...
    public ApiResponse<List<DtoFilteredFilms>> GetFilteredFilms(DtoFilmsQuery dto)
    {
        try
        {
            ...
            return new ApiResponse<List<DtoFilteredFilms>> { Data = result };
        }
    ...
    public ApiResponse<string> AddFilm(DtoAddFilm filmDto)
    {
        try
        {
            var film = new Film
    ...
    public ApiResponse<string> UpdateFilm(int id, DtoUpdateFilm newFilm)
    {
